...
public class AdapterItemVideo extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterItemVideo(Context context, ArrayList<VideoInfo> lsitVideoInfo, int layoutResource) {
